    ...
    <div class="card shadow  connectedSortable1" >
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-sm-6  @if($element->trashed()) disabled @endif">@livewire('element-text', ['element_id'=>$element->id, 'text'=>$element->text, 'type'=>$element->type], key($element->id))</div>
                <div class="col-sm-3  @if($element->trashed()) disabled @endif">
                    <div class="dropdown">
                ...
                @foreach($elements as $key => $elem)
                    <li id="sub_{{$elem->id}}" alt="{{$element->id}}">
                        <div class="row shadow my-3">
                            ...
                            <div class="col-sm-9 pt-1" @if ($elem->trashed())  style="pointer-events: none; opacity: 0.5; background: #CCC;"  @endif >                                                              
                        ...
                        @foreach($elements as $key => $elem)
                            ...
                            <li id="sub_{{$elem->id}}" alt="{{$element->id}}">
                                <div class="row shadow my-3">
                                    ...
                                    <div class="col-sm-8 pt-1" @if ($elem->trashed())  style="pointer-events: none; opacity: 0.5; background: #CCC;"  @endif >                                                              
                                        @if($elem->type == 'short_text' || $elem->type == 'long_text')
                                            Other...
                                        @else                            
                                            @livewire('element-text', ['element_id'=>$elem->id, 'text'=>$elem->text, 'type'=>$elem->type], key($elem->id))
                        ...
                        @foreach($elements as $key => $elem)
                            ...
                            <li id="sub_{{$elem->id}}" alt="{{$element->id}}">
                                <div class="row shadow my-3">
                                    ...
                                    <div class="col-sm-7 pt-1" @if ($elem->trashed())  style="pointer-events: none; opacity: 0.5; background: #CCC;"  @endif >                                                              
                                        @if($elem->type == 'short_text' || $elem->type == 'long_text')
                                            Other...
                                        @else                            
        ...
        <div class="card-footer text-muted text-right">
            ...
            @else
                <i wire:click="required({{$element->id}}, 0)" title="Required" class="mx-3 text-success fas fa-toggle-on fa-2x"></i>
            @endif
