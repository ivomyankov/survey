<div class="col-12 bg-light rounded shadow p-4 my-4">{{--dd($result, $devide)--}}
    @foreach($element as $key => $option)
        @if($key==0)
            <div class="row">  
                <b>{{$element[0]->text}}</b>
                <br><i>Bitte vergeben Sie Noten von 1-5 für die Themen: „1“ bedeutet „sehr gut“ und „{{$scale}}“ bedeutet „nicht zufriedenstellend“. Selbstverständlich können Sie auch alle Noten dazwischen vergeben</i>
            </div>
        @else
